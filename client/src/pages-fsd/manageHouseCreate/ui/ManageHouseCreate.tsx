...
import {
    createHouseMutation,
    updateHouseMutation,
    getHouseDetailQuery, getHouseAllQuery,
...
const YMapPicker = dynamic(() => import("@/widgets/YmapPicker/ui/YMapPicker").then(m => m.YMapPicker), {
    ssr: false,
});
...
const ManageHouseCreate = ({houseId}: ManageHouseFormProps) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                ...
                <YMapPicker
                    defaultLat={watch("lat")}
                    defaultLng={watch("lng")}
                    onChange={(lat, lng) => {
                        setValue("lat", lat);
                        setValue("lng", lng);
...
export default ManageHouseCreate